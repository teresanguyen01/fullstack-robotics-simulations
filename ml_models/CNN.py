...
# Load data
train_input_path = 'ml_rl/rawan_0812/output_whole/sensor_train.csv'
train_output_path = 'ml_rl/rawan_0812/output_whole/mocap_train.csv'
test_input_path = 'ml_rl/rawan_0812/output_whole/sensor_test.csv'
test_output_path = 'ml_rl/rawan_0812/output_whole/mocap_test.csv'
