"""
MOCAP & SENSOR STEP 2 (ML): 
Takes in two directories (mocap and sensor) and returns the training sets (70%) and testing sets (30%) for ML.
"""
import glob
import os
import pandas as pd
...
def _person_from_sensor_filename(sensor_basename: str) -> str:
    """Assumption that how to match is through _sensor but should probably change to just having the name.
