#!/usr/bin/env python3
"""
SENSOR STEP 1.5 (OPTIONAL)
Sensor data: drop any rows past a certain threshold (outliers) to account for sensors disconnecting.
Written in Python3. Input should be the sensor data after MATLAB processing.
...
def parse_args() -> argparse.Namespace:
    """
    Gives many options on outlier cleaning.
    """
