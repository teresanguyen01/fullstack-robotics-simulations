...
path2 <- "data_0724/teresa/raw_mocap/doubleLateral_GS_Teresa_1_003.csv"
...
names(joint_map) <- gsub("^Skeleton", "skeleton", names(joint_map))
# joint_map 
# 
...
path2 <- "/home/tt/soft-robotics-simulations2/inter.csv"
...
# path2 <- "data/teresa/raw_data/random_Tpath <- file.path("~", "Documents", "Faboratory Stuff", "soft-robotics-simulations2", "cleaned_mocap_data", "shoulder_move_Veronica_071025.csv")
path2 <- "data_0724/teresa/proc_mocap/double_lat_Teresa_072525_3.csv"
